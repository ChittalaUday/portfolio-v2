...
export type DitherImageOverlayProps = Omit<ImgHTMLAttributes<HTMLImageElement>, "style"> & {
  fill?: boolean
...
/**
 * Image element tuned for a `DitherImageFrame`. Fills the frame by default.
 */
const DitherImageContent = forwardRef<
  HTMLImageElement,
  DitherImageContentProps
>(function DitherImageContent({ className, alt, fill, ...props }, ref) {
